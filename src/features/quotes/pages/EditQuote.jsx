// features/quotes/pages/EditQuote.jsx
...
const EditQuote = () => {
  ...
  const handleSubmit = async (quoteData) => {
    console.log('🎯 handleSubmit called in EditQuote with data:', quoteData);
    setSubmitError(null);
      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            <CustomButton
              label="Save Changes"
              onClick={() => document.getElementById('submit-quote-form').click()}
            /> */}
          </>
        }
      />
